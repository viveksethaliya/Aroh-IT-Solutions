...
export const metadata: Metadata = {
  title: "Services",
  description: "Web platforms, e-commerce builds, SEO, digital marketing, design and ongoing maintenance. Six practices, and how we scope each one.",
  alternates: {
    canonical: "/services",
  },
};
                ...
                <FadeIn key={index} delay={0.1} viewportMargin="-100px">
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16 items-center">
                    ...
                    <div className={cn(
                      ...
                      <div 
                        className="h-16 w-16 rounded-[10px] bg-raised flex items-center justify-center mb-2"
                        style={{ boxShadow: "var(--bevel), var(--lift-1)" }}
                      >
